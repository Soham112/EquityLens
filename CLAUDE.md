...
core/
  ...
  sector_map.py          Single source of truth: 11 macro sectors, 34 microsectors, 14 wildcards
...
11 macro sectors → 34 microsectors + 14 wildcards. Used by the weekly funnel (scout.py).
